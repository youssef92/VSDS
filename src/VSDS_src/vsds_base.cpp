...
VSDS_base::VSDS_base(Vec x0):
    ...
    int K_SEDS=3 ;
    node_handle_.getParam("/K_SEDS", K_SEDS);
    ...
    node_handle_.getParam("/VSDS_name",DS_ModelName);
...
Mat VSDS_base::GetStiffness(Vec x)
{
  ...
  //    k22= 1000 + 800*smooth_transition_fall(x(1),0.16,0.04); // Used For Drilling
        ...
        string Stiff_type ;
        node_handle_.getParam("/Stiff_type",Stiff_type) ;
